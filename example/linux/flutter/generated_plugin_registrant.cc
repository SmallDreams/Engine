...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) salem_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "SalemPlugin");
  salem_plugin_register_with_registrar(salem_registrar);
}
